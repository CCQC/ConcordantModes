...
os.mkdir('Intder')
shutil.copy('templates/intder_init_template.dat','Intder')
...
os.system('python ../subprocess_Scripts/GrabSym.py')
...
os.system('python subprocess_Scripts/DirectoryTree.py')
os.chdir('Disps')
dispList = []
...
os.system('python ../subprocess_Scripts/Reap.py')

# Now to generate the e.m file, then to generate the force constants!
os.chdir('../mma')
os.system('python ../subprocess_Scripts/GenEM.py')
os.system('python ../subprocess_Scripts/GenFC.py')
os.system('./FC.wls')

# And now we scoot back over to the Intder directory to run the final hessian!
os.chdir('../Intder')
os.system('python ../subprocess_Scripts/Final_intder_input.py')
os.system('python ../subprocess_Scripts/Gen_Final_Intder.py')
